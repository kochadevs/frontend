...
export default function Mentorship() {
  ...
  const isMentor = user?.user_type?.toLowerCase() === "mentor";
  const isMentee = user?.user_type?.toLowerCase() === "mentee";

  // If activeTab is not set yet, don't render buttons
  if (!activeTab) {
    return (
      <div className="min-h-[80vh] bg-gradient-to-br from-gray-50 to-blue-50/30 flex items-center justify-center">
        ...
        <div className="relative z-20 flex items-center justify-center h-full">
          {isMentor && (
            <Button
              ...
              className={`flex rounded-none flex-col items-center justify-center h-full w-[93px] border-b-2 transition-all duration-200 ${
                activeTab === "mentor"
            ...
            >
              ...
              >
                <path
                  ...
                  stroke={activeTab === "mentor" ? "#334AFF" : "#fff"}
                  strokeWidth="1.67"
                  strokeLinecap="round"
            ...
            >
              ...
              >
                <path
                  ...
                  stroke={activeTab === "mentee" ? "#334AFF" : "#fff"}
                  strokeWidth="1.67"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
        ...
        {activeTab === "mentor" && (
          <div>
            ...
            <p className="text-gray-600">
              ...
              mentees, schedule sessions, and track progress.
            </p>

...
import { CreateMentorPackageFormData, CreateMentorPackageRequest, MentorPackage } from "@/interface/mentorPackages";
...
interface EditPackageModalProps {
  ...
  isOpen: boolean;
  onClose: () => void;
  onUpdatePackage: (packageId: number, packageData: CreateMentorPackageRequest) => Promise<void>;
  isLoading?: boolean;
}
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="text-xl font-semibold text-gray-900 flex items-center gap-2">
            <Edit className="w-5 h-5 text-[#334AFF]" />
            Edit Package
          </DialogTitle>
        </DialogHeader>
